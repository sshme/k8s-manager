...
const (
	...
	PluginService_UpdatePluginTrustStatus_FullMethodName = "/market.v1.PluginService/UpdatePluginTrustStatus"
...
type PluginServiceClient interface {
	...
	UpdatePluginTrustStatus(ctx context.Context, in *UpdatePluginTrustStatusRequest, opts ...grpc.CallOption) (*UpdatePluginTrustStatusResponse, error)
	// Release management
...
func (c *pluginServiceClient) UpdatePluginTrustStatus(ctx context.Context, in *UpdatePluginTrustStatusRequest, opts ...grpc.CallOption) (*UpdatePluginTrustStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdatePluginTrustStatusResponse)
	err := c.cc.Invoke(ctx, PluginService_UpdatePluginTrustStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PluginServiceServer interface {
	...
	UpdatePluginTrustStatus(context.Context, *UpdatePluginTrustStatusRequest) (*UpdatePluginTrustStatusResponse, error)
	// Release management
...
func (UnimplementedPluginServiceServer) UpdatePluginStatus(context.Context, *UpdatePluginStatusRequest) (*UpdatePluginStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePluginStatus not implemented")
}
func (UnimplementedPluginServiceServer) UpdatePluginTrustStatus(context.Context, *UpdatePluginTrustStatusRequest) (*UpdatePluginTrustStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePluginTrustStatus not implemented")
}
...
func (UnimplementedPluginServiceServer) GetArtifactByPlatform(context.Context, *GetArtifactByPlatformRequest) (*GetArtifactResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetArtifactByPlatform not implemented")
}
...
func _PluginService_UpdatePluginTrustStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePluginTrustStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PluginServiceServer).UpdatePluginTrustStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PluginService_UpdatePluginTrustStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PluginServiceServer).UpdatePluginTrustStatus(ctx, req.(*UpdatePluginTrustStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PluginService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdatePluginTrustStatus",
			Handler:    _PluginService_UpdatePluginTrustStatus_Handler,
		},
		{
